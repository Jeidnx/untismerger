...
export default function AddDialog(props: propType) {
	...
	>
		...
		<DialogContent>
			<DialogContentText>Bitte gib hier die benötigten Daten ein. Zur nachverfolgung wird eine Referenz zu deinem
				Nutzernamen bei uns gespeichert.</DialogContentText>
			<Box
				sx={{
